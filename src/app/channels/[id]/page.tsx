...
export default async function Channel({params}:{params:Promise<{id:string}>}){
  ...
  return <main className="mx-auto min-h-screen max-w-6xl px-4 py-8">
    ...
    {c.url&&<p className="mt-3 text-xs text-slate-500">Android users can cast this external player to a CricketHub TV receiver with one tap after the free apps are installed.</p>}
  </main>
}
