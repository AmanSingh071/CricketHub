    ...
    {open && <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-label="Mirror player to TV">
      <div className="w-full max-w-md rounded-3xl border border-[#29445e] bg-[#081321] p-6 shadow-2xl">
        ...
        {(status === "waiting" || status === "connecting") && <>
          <div className="mt-7 rounded-2xl border border-green-400/20 bg-green-500/[.05] p-5 text-center"><p className="text-xs font-black uppercase tracking-[.18em] text-slate-500">Enter this code on your TV</p><p className="mt-3 select-all text-5xl font-black tracking-[.22em] text-green-300">{code}</p></div>
          <ol className="mt-5 space-y-2 text-sm text-slate-300"><li><b>1.</b> Open <span className="font-bold text-white">CricketHub /tv</span> on the TV browser.</li><li><b>2.</b> Enter the 6-digit code and press Connect.</li><li><b>3.</b> Click <b>Start mirroring</b> here.</li><li><b>4.</b> Choose <b>This tab</b> in the browser picker and enable tab audio if offered.</li></ol>
